OC.L10N.register(
    ...
    "This app allows limiting the number of downloads for external link shares." : "此應用程式允許限制外部連結分享的下載數量。",
    ...
    "This share was limited to {limit} downloads. There is still {countLeft} left allowed." : "此分享僅限 {limit} 次下載。還允許 {countLeft} 次。"
},
"nplurals=1; plural=0;");
