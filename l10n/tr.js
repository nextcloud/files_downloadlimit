OC.L10N.register(
    ...
    "This app allows limiting the number of downloads for external link shares." : "Bu uygulama dış bağlantı paylaşımlarının indirme sayısının sınırlanmasını sağlar.",
    "The minimum limit is 1" : "En az sınır 1 olabilir",
    "Failed to set download limit" : "İndirme sınırı ayarlanamadı",
    "Failed to remove download limit" : "İndirme sınırı kaldırılamadı",
    ...
    "Default download limit for external shares" : "Dış paylaşımlar için varsayılan indirme sınırı",
    ...
    "Failed to remove default download limit" : "Varsayılan indirme sınırı kaldırılamadı"
},
