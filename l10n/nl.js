OC.L10N.register(
    "files_downloadlimit",
    {
    "Files download limit" : "Downloadlimiet bestanden",
    "File link share download limit" : "Bestand deel link download limiet",
    ...
    "Download count: {count}" : "Download aantal: {count}",
