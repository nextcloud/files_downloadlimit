OC.L10N.register(
    ...
    "Allow to limit the number of downloads for link shares" : "Salli rajoittaaksesi latausten määrää jaetuille osoitteille",
    "Download limit" : "Latausrajoitus",
    "Download count: {count}" : "Latausmäärä: {count}",
